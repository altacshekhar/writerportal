			...
			<div id="profile-tab" class="content-panel py-2 px-3">
				...
				<?php echo form_open_multipart('', array('class' => 'form-horizontal form-validate', 'id' => 'seoconfig-form'));?>
					<div class="form-group row">
						<label class="col-md-4 col-sm-6 h6 col-form-label" for="seoconfig_api_url">
								Api url
						</label>
						<div class="col-sm-6">
							<?php
							$data_api_url = array(
								'id' => 'seoconfig_api_url',
								'name' => 'seoconfig_api_url',
								'value' => set_value('seoconfig_api_url', $config_row['seoconfig_api_url']),
								'placeholder' => 'Set the api url for tf-idf',
								'class' => 'form-control'
							);
							echo form_input($data_api_url);
							?>
							<small class="form-text text-muted">
								Set the api url for tf-idf seo
							</small>
							<?php echo form_error('seoconfig_api_url');?>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-md-4 col-sm-6 h6 col-form-label" for="seoconfig_search_count">
							No. Of Search Count
						</label>
						<div class="col-sm-6">
							<?php
							$data_search_count = array(
								'id' => 'seoconfig_search_count',
								'name' => 'seoconfig_search_count',
								'value' => set_value('seoconfig_search_count', $config_row['seoconfig_search_count']),
								'placeholder' => 'Set the number of search count ex (20)',
								'class' => 'form-control'
							);
							echo form_input($data_search_count);
							?>
							<small class="form-text text-muted">
								Set the number of search count
							</small>
							<?php echo form_error('seoconfig_search_count');?>
						</div>
					</div>
