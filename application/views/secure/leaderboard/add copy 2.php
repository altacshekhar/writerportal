					 ...
					 ?>
							<div class="col pt-2 mt-1">
								...
								<a class="deleteBacklink"
									href="<?php echo site_url('/secure/campaigns/delete_backlinkt/' . $backlink['link_wp_articles_id']);?>"
									data-toggle="confirmation"
									data-icon-type="error"
									data-title="Delete this Backlink URL?"
									data-message="This backlink will be removed from backlinks and this can not be <b>Undone</b>."
									...
									data-target="#backlink-<?php echo $backlink['link_wp_articles_id']?>">
									<i class="fas fa-times text-danger fa-lg" data-toggle="tooltip" data-placement="top" data-original-title="Remove Backlink"></i>
								</a>
