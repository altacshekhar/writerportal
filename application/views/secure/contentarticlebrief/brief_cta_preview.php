...
<?php
 if($brief_cta_type == 'signup'){
?>

<div id="call-to-action-wrap" class="hero cta-video mb-3" style="<?php if ($brief_cta_background_type == 'color') { echo "background-color:". $brief_cta_background_color.";"; } ?><?php if($brief_cta_background_type == 'image') { echo "background-image: url('". site_url($brief_cta_background_image) . "'); background-repeat: no-repeat; background-size: contain;"; } ?>">
    <?php if ($brief_cta_background_type == 'video') { ?>
     <div id="ytbg" data-ytbg-fade-in="true" data-youtube="<?php echo $brief_cta_background_video; ?>"></div>
    <?php } ?>
  <div class="padding-wrap-xl-both tint text-center">
    <div class="container text-center">
			<p class="lead"><?php echo $brief_cta_headline; ?><br><strong><?php echo $brief_cta_sub_headline; ?></strong></p> 
			<button type="button" class="btn btn-success" style="background-color: <?php echo $brief_cta_button_color; ?>; border-color: <?php echo $brief_cta_button_color; ?>"> <?php echo $brief_cta_button_text; ?></button>
    </div> 
  </div>
</div>
<?php
...
<?php
 if($brief_cta_type == 'leadcapture'){
?>

<div id="call-to-action-wrap" style="background-color:#ccc ;" class="mb-3">
  <div class="hero inline-form">
  <?php if ($brief_cta_background_type == 'video') { ?>
    <div class="overlay"></div>
      <div id="ytbg" data-ytbg-fade-in="true" data-youtube="<?php echo $brief_cta_background_video; ?>"></div>
      <?php } ?>
    <div style="<?php if ($brief_cta_background_type == 'color') { echo "background-color:". $brief_cta_background_color.";"; } ?><?php if($brief_cta_background_type == 'image') { echo "background-image: url('". site_url($brief_cta_background_image) . "'); background-repeat: no-repeat; background-size: contain; background-position: center center;"; } ?>"> 
        ...
        <div class="mauticform-innerform">
          <div class="mauticform-page-wrapper mauticform-page-1" data-mautic-form-page="1">
            ...
            <div id="mauticform_cta27_submit" class="mauticform-row mauticform-button-wrapper mauticform-field-3">
              <button type="submit" name="mauticform[submit]"  style="background-color: <?php echo $brief_cta_button_color; ?>; border-color: <?php echo $brief_cta_button_color; ?>" id="mauticform_input_cta27_submit"
                class="mauticform-button btn btn-success" value="1"><?php echo $brief_cta_button_text; ?></button> </div>
          </div>
