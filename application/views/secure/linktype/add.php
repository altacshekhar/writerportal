	...
	<div class="container">
		<div class="view-account">
			...
			<div id="profile-tab" class="content-panel py-2 px-3">
				...
				<?php
				//pre( $category_row);
				$attributes = array('class' => 'form-horizontal form-validate', 'id' => 'type-form');
				echo form_open_multipart('', $attributes);
				?>
				<div class="form-group row">
					<label class="col-md-4 col-sm-6 h6 col-form-label" for="type_name">
					Type Name
					</label>
					<div class="col-sm-6">
						<?php
						$data_linktype_name = array(
							'id' => 'type_name',
							'name' => 'type_name',
							'value' => set_value('type_name', $type_row['type_name']),
							'placeholder' => 'Type Name',
							'class' => 'form-control'
						);
						echo form_input($data_linktype_name);
						?>
				...
				<div class="form-group row mt-3">
					<div class="col-md-8 col-sm-9 col-xs-12 offset-md-4 offset-sm-3">
						<button type="submit" name="submitForm" value="" class="btn btn-primary " data-disable-with="Loading..." autocomplete="off">
							...
							<?php if(isset($type_row['type_id'])) {
								echo 'Update Type';
								} else {
									echo 'Add Type';
								};?>
						</button>
						<a href="<?php echo site_url('/secure/linktype') ?>" class="btn ml-1 btn-default">
							Cancel
						</a>
					</div>
				</div>
