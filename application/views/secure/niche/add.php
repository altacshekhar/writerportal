	...
	<div class="container">
		<div class="view-account">
			...
			<div id="profile-tab" class="content-panel py-2 px-3">
				...
				<?php
				//pre( $category_row);
				$attributes = array('class' => 'form-horizontal form-validate', 'id' => 'niche-form');
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<?php
						$data_niche_name = array(
							'id' => 'niche_name',
							'name' => 'niche_name',
							'value' => set_value('niche_name', $niche_row['niche_name']),
							'placeholder' => 'Niche Name',
							'class' => 'form-control'
						);
						echo form_input($data_niche_name);
						?>
						<?php echo form_error('niche_name');?>
					</div>
				</div>
				<div class="form-group row mt-3">
					<div class="col-md-8 col-sm-9 col-xs-12 offset-md-4 offset-sm-3">
						<button type="submit" name="submitForm" value="" class="btn btn-primary " data-disable-with="Loading..." autocomplete="off">
							...
							<?php if(isset($niche_row['niche_id'])) {
								echo 'Update Niche';
								} else {
									echo 'Add Niche';
								};?>
						</button>
						<a href="<?php echo site_url('/secure/niche') ?>" class="btn ml-1 btn-default">
							Cancel
						</a>
					</div>
				</div>
