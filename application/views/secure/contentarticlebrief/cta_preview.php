<?php
 if($cta_type == 'signup'){
?>
<div id="call-to-action-wrap" class="hero cta-video mb-1" style="<?php if ($cta_background_type == 'color') { echo "background-color:". $cta_background_color.";"; } ?><?php if($cta_background_type == 'image') { echo "background-image: url('". site_url($cta_background_image) . "'); background-repeat: no-repeat; background-size: contain;"; } ?>">
...
<div id="call-to-action-wrap" style="background-color:#ccc ;" class="mb-1">
