	     ...
	     <div class="container">
				...
				<div class="form-actions inline-spacing mt-2 mb-1">
						...
						<a type="button" href="<?php echo site_url('/optimizecontent/export_optimize_content_keywords/'.$article['article_id'].'/'. $article['language_id']) ?>" data-keyword="<?php echo $article['article_meta_keyword'] ?>" data-article="<?php echo $article['article_id'] ?>"
							data-lang="<?php echo $article['language_id'] ?>" id="export-keywords" class="btn btn-secondary btn-icon export-keywords" target="_parent" <?php echo ($article['language_id']=='en') ? '' : 'disabled'?>>
										...
										<div class="row">
											...
											<div class="article-modal-article-type">
												<div class="custom-control custom-radio custom-control-inline">
													...
													<div class="custom-control custom-radio custom-control-inline">
														<input type="radio" id="recipeArticle1" name="articleBlogType" value="recipe" data-json-category='<?php echo $recipe_categories ?>' class="custom-control-input"  disabled>
														<label class="custom-control-label" for="recipeArticle1">Recipe Article</label>
													</div>
													<div class="custom-control custom-radio custom-control-inline">
														<input type="radio" id="pressRelease1" name="articleBlogType" value="news" data-json-category='<?php echo $news_categories ?>' class="custom-control-input" checked>
									...
									<div class="row article-setting">
										...
										<div class="row article-setting">
											<div class="<?php echo ($article['article_id']) ? 'form-group col-md-6 mb-2' : 'form-group col-md-12 mb-2'?>">
												...
												<?php
													echo form_dropdown("article[$lang][article_type]", $types, 'news', 'class="form-control select-2" required="required" data-msg-required="Please select article type" id => "article_type"' );
