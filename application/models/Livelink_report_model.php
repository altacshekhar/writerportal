...
class Livelink_report_model extends MY_Model
{
    ...
    private function _get_datatables_query($post_array)
    {
        ...
        // );
        $column_search = array(
            $table_campaign . '.campaign_outreach_coordinator',
        ...
        $this->db->where($table_link_briefs.'.brief_live_validation_status','failed');
        $this->db->or_where($table_link_briefs.'.brief_live_validation_status','valid');
        ...
        $this->db->group_by($table_campaign. '.campaign_outreach_coordinator');
