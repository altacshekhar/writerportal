				...
				<div class="form-group row">
						...
						<div class="col-sm-6">
							<?php
								...
								echo form_dropdown('website', $site, $website_config_row["website"], 'class="custom-select"' );
								
							?>
							<small class="form-text text-muted">
								Select the website for meta tags
							</small>
					...
					<div class="form-group row">
						...
						$default_meta_product = array(
								...
								'value' => set_value('default_meta_product', $website_config_row['default_meta_product']),
					...
					<div class="form-group row">
						...
						$available_blog_categories = array(
								...
								'value' => set_value('available_blog_categories', $website_config_row['available_blog_categories']),
					...
					<div class="form-group row">
						...
						$rakefile = array(
								'id' => 'rakefile',
								'name' => 'rakefile',
								'value' => set_value('rakefile', $website_config_row['rakefile'], $html_escape=FALSE),
