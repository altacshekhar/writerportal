...
if(array_key_exists('error',$optimizecontent))
{?>
	<div class="card content-o-sidebar">
		<div class="card-body pb-0 content-o-header">
			...
			<h4 class="font-weight-normal text-primary"><?php echo $optimizecontent['error']; ?></h4>
		</div>
	</div>
<?php }
elseif($optimizecontent['content_performance']['total_word_on_page'] > 0){
		...
		<div class="card-body pt-0 content-o-body">
			...
			<div id="accordion-2" class="accordion">
				<div class="card border-success">
					<div class="alert alert-success d-flex justify-content-between align-items-center m-0 collapsed" id="heading-1-1" data-toggle="collapse" role="button" data-target="#collapse-2-1" aria-expanded="false" aria-controls="collapse-2-1" style="">
					...
					<div id="collapse-2-1" class="collapse" aria-labelledby="heading-2-1" data-parent="#accordion-2" style="">
				...
				<div class="card border-primary">
					<div class="alert alert-primary d-flex justify-content-between align-items-center m-0 collapsed" id="heading-1-2" data-toggle="collapse" role="button" data-target="#collapse-2-2" aria-expanded="false" aria-controls="collapse-2-2" style="">
					...
					<div id="collapse-2-2" class="collapse" aria-labelledby="heading-2-2" data-parent="#accordion-2" style="">
						<div class="card-body pb-0 pr-0">
							<div class="kw-group-items">
				...
				<div class="card  border-warning rounded-0">
					<div class="alert alert-warning d-flex justify-content-between align-items-center  m-0 collapsed" id="heading-1-3" data-toggle="collapse" role="button" data-target="#collapse-2-3" aria-expanded="false" aria-controls="collapse-2-3" style="">
				...
				<div class="card border-danger rounded-0">
					<div class="alert alert-danger d-flex justify-content-between align-items-center m-0 collapsed" id="heading-1-4" data-toggle="collapse" role="button" data-target="#collapse-2-4" aria-expanded="false" aria-controls="collapse-2-4" style="">
					...
					<div id="collapse-2-4" class="collapse" aria-labelledby="heading-2-4" data-parent="#accordion-2" style="">
						<div class="card-body pb-0 pr-0">
							<div class="kw-group-items">
				...
				<div class="card border-info rounded-0">
					<div class="alert alert-light d-flex justify-content-between align-items-center m-0 collapsed" id="heading-1-5" data-toggle="collapse" role="button" data-target="#collapse-2-5" aria-expanded="false" aria-controls="collapse-2-5" style="">
					...
					<div id="collapse-2-5" class="collapse" aria-labelledby="heading-2-5" data-parent="#accordion-2" style="">
						<div class="card-body pb-0 pr-0">
							<div class="kw-group-items">
