									...
									<div class="row article-setting">
										...
										<div class="row article-setting">
											...
											<div class="form-group col-md-6 mb-2">
												...
												//echo form_dropdown("article[$lang][article_leadcapture_cta]", $cta, $article['articarticle_leadcapture_ctale_content_cta'], 'class="form-control select-2" required="required" data-msg-required="Please select leadcapture cta" id => "article_leadcapture_cta"' );
