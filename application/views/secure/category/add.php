	...
	<div class="container">
		<div class="view-account">
			...
			<div id="profile-tab" class="content-panel py-2 px-3">
				...
				<?php
				//pre( $category_row);
				$attributes = array('class' => 'form-horizontal form-validate', 'id' => 'category-form');
				echo form_open_multipart('', $attributes);
				?>
				<div class="form-group row">
					<label class="col-md-4 col-sm-6 h6 col-form-label" for="category_name">
					 Category Name
					</label>
					<div class="col-sm-6">
						<?php
						$cat = array(
						  ...
						  echo form_dropdown('category_parent', $cat, $category_row['category_parent'], 'class="form-control select-2"' );
						?>
				...
				<div class="form-group row">
					...
					<div class="col-sm-6">
						<?php
						$data_category_name = array(
							'id' => 'category_name',
							'name' => 'category_name',
							'value' => set_value('category_name', $category_row['category_name']),
							'placeholder' => 'Sub Category Name, ex. Business Management',
							'class' => 'form-control'
						);
						echo form_input($data_category_name);
						?>
						<?php echo form_error('category_name');?>
					</div>
				</div>
				<div class="form-group row">
					<label class="col-md-4 col-sm-6 h6 col-form-label" for="category_slug">
					Sub Category Slug
					</label>
					<div class="col-sm-6">
						<?php
						$data_category_slug = array(
							'id' => 'category_slug',
							'name' => 'category_slug',
							'value' => set_value('category_slug', $category_row['category_slug']),
							'placeholder' => 'Sub Category Slug, ex. business',
							'class' => 'form-control'
						);
						echo form_input($data_category_slug);
						?>
				...
				<div class="form-group row mt-3">
					<div class="col-md-8 col-sm-9 col-xs-12 offset-md-4 offset-sm-3">
						<button type="submit" name="submitForm" value="" class="btn btn-primary " data-disable-with="Loading..." autocomplete="off">
							...
							<?php if(isset($category_row['category_id'])) {
								echo 'Update Category';
								} else {
									echo 'Add Category';
								};?>
						</button>
						<a href="<?php echo site_url('/secure/category') ?>" class="btn ml-1 btn-default">
							Cancel
						</a>
					</div>
				</div>
