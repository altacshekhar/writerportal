			...
			<div class="modal-body">
                ...
                <div class="row pt-1">
                    ...
                    <div class="col-md-8 article-brief-article-type">
                        ...
                        if($articlesbrief['brief_article_skyscraper'] != "")
                            $skyscraper = 'checked';
                ...
                <div class="blog-show-brief hide">
                    <div class="row pt-1">
                        <div class="col-md-4">
                            <label for="article-master-category">Category</label>
                        </div>
                        <div class="col-md-8">
                        <select class="form-control" id="brief_article_category" name="brief_article_category">
                        <?php
                ...
                <div class="blog-show-brief hide">
                    <div class="row pt-1">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <!-- <input type="text" class="form-control" id="tags" name="brief_article_tags" placeholder="ex. Food Safety, Healthy Food, HACCP"> -->
                                <?php
                                $data_brief_article_tags = array(
                                    'name' => "brief_article_tags",
                                    'value' => set_value("brief_article_tags", $articlesbrief['brief_article_tags'], $html_escape=FALSE),
                                    'placeholder' => 'ex. Food Safety, Healthy Food, HACCP',
                                    'class' => 'form-control',
                                    'required' => 'required',
                                    'autocomplete' => 'off',
                                    'data-msg-required'=>"Please enter article tags"
                                );
                                echo form_input($data_brief_article_tags);
                                echo form_error("brief_article_tags");
                                ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="blog-show-brief hide">
                    <div class="row pt-1">
                        <div class="col-md-4">
                            <label for="skyscraper">Skyscraper</label>
                        </div>
                        <div class="col-md-8">
                            <!-- <input class="" type="checkbox" id="skyscraper" name="brief_article_skyscraper" value="true"> -->
                            <?php
                            $data_brief_article_skyscraper = array(
                                'id' => "brief_article_skyscraper",
                                'name' => "brief_article_skyscraper",
                                'value' =>'true',
                                'checked' => $skyscraper
                            );
                            echo form_checkbox($data_brief_article_skyscraper);
                            ?>
                        </div>
                    </div>
                </div>
