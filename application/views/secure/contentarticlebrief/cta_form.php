...
<?php if (isset($brief_cta_data)){ //pre($brief_cta_data->brief_cta_headline);?>
<div class="form-group row">
<label class="col-md-4 col-sm-6 h6 col-form-label" for="cta_headline">
    Headline
</label>
...
$cta_id = array(
    'id' => 'cta_id',
    'name' => 'cta_id',
    'value' => set_value('cta_id', $brief_cta_data->cta_id),
    'type' => 'hidden'
);
echo form_input($cta_id);
echo form_error('cta_id');

$brief_cta_id = array(
    'id' => 'brief_cta_id',
    'name' => 'brief_cta_id',
    'value' => set_value('brief_cta_id', $brief_cta_data->brief_cta_id),
    'type' => 'hidden'
);
echo form_input($brief_cta_id);
echo form_error('brief_cta_id');
?>

<div class="col-sm-6">
<?php
$brief_cta_headline = array(
    'id' => 'brief_cta_headline',
    'name' => 'brief_cta_headline',
    'value' => set_value('brief_cta_headline', $brief_cta_data->brief_cta_headline),
    'placeholder' => 'CTA Headline',
    'class' => 'form-control'
);
echo form_input($brief_cta_headline);
?>
<?php echo form_error('brief_cta_headline');?>
</div>
</div>
<div class="form-group row">
<label class="col-md-4 col-sm-6 h6 col-form-label" for="cta_description">
...
<div class="col-sm-6">
<?php
    $brief_cta_sub_headline = array(
        'id' => 'brief_cta_sub_headline',
        'name' => 'brief_cta_sub_headline',
        'value' => set_value('brief_cta_sub_headline', $brief_cta_data->brief_cta_sub_headline),
        'placeholder' => 'CTA Subheadline',
        'class' => 'form-control'
    );
    echo form_input($brief_cta_sub_headline);
    ?>
    <!-- <small class="form-text text-muted">
    Enter the cta subheadline for cta
    </small> -->
    <?php echo form_error('brief_cta_sub_headline');?>
</div>
</div>
<div class="form-group row">
<label class="col-md-4 col-sm-6 h6 col-form-label">
...
<div class="col-sm-6">
    ...
    $brief_cta_button_text = array(
        'id' => 'brief_cta_button_text',
        'name' => 'brief_cta_button_text',
        'value' => set_value('brief_cta_button_text', $brief_cta_data->brief_cta_button_text),
        'placeholder' => 'CTA Button Text',
        'class' => 'form-control'
    );
    ...
    <?php echo form_error('brief_cta_button_text'); ?>
</div>
</div>
<div class="form-group row">
<label class="col-md-4 col-sm-6 h6 col-form-label">
...
<div class="col-sm-6">
    ...
    $brief_cta_button_color = array(
        'id' => 'brief_cta_button_color',
        'name' => 'brief_cta_button_color',
        'value' => set_value('brief_cta_button_color', $brief_cta_data->brief_cta_button_color),
        'placeholder' => 'CTA Button Color',
        'class' => 'form-control'
    );
    echo form_input($brief_cta_button_color);
   $brief_cta_seq = array(
        'value' => $brief_cta_data->cta_seq,
        'type'  => 'hidden',
        'id' => 'cta_seq_no',
        'name' => 'cta_seq_no'
    );
    ...
    <?php echo form_error('brief_cta_button_color'); ?>
</div>
</div>
<?php
$brief_cta_background_type = array(
'name'  => 'brief_cta_background_type',
'value' => set_value('brief_cta_background_type', $brief_cta_data->brief_cta_background_type),
'type'  => 'hidden',
'class' => 'cta-button-type'
);
echo form_input($brief_cta_background_type);
$brief_cta_website = array(
'name'  => 'brief_cta_website',
'value' => set_value('brief_cta_website', $brief_cta_data->brief_cta_website),
'type'  => 'hidden'
);
echo form_input($brief_cta_website);
$brief_cta_language_id = array(
'name'  => 'brief_cta_language_id',
'value' => set_value('brief_cta_language_id', $brief_cta_data->brief_cta_language_id),
'type'  => 'hidden'
);
echo form_input($brief_cta_language_id);
$brief_cta_type = array(
'name'  => 'brief_cta_type',
'value' => set_value('brief_cta_type', $brief_cta_data->brief_cta_type),
'type'  => 'hidden'
);
echo form_input($brief_cta_type);
$brief_cta_background = array(
'name'  => 'brief_cta_background',
'value' => set_value('brief_cta_background', $brief_cta_data->brief_cta_background),
'type'  => 'hidden'
);
echo form_input($brief_cta_background);
$brief_cta_background_image = array(
'name'  => 'brief_cta_background_image',
'value' => set_value('brief_cta_background_image', $brief_cta_data->brief_cta_background_image),
'type'  => 'hidden'
);
echo form_input($brief_cta_background_image);
$brief_cta_background_color = array(
'name'  => 'brief_cta_background_color',
'value' => set_value('brief_cta_background_color', $brief_cta_data->brief_cta_background_color),
'type'  => 'hidden'
);
echo form_input($brief_cta_background_color);
$brief_cta_background_video = array(
'name'  => 'brief_cta_background_video',
'value' => set_value('brief_cta_background_video', $brief_cta_data->brief_cta_background_video),
'type'  => 'hidden'
);
echo form_input($brief_cta_background_video);
$brief_cta_form_id = array(
'name'  => 'brief_cta_form_id',
'value' => set_value('brief_cta_form_id', $brief_cta_data->brief_cta_form_id),
'type'  => 'hidden'
);
echo form_input($brief_cta_form_id);
?>
