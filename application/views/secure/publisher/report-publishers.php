...
<div class="clearfix position-relative pt-2 pb-4">
	<div class="container">
		...
		<div class="highlight">
			<div class="report-publisher-filters">
		...
		<div class="table-responsive">
			<table id="publisher_report" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						<th class="" >Link Prospector</th>
						<th class="text-center">No. of Publishers</th>
                        <th></th>
					</tr>
				</thead>
				<tbody></tbody>
