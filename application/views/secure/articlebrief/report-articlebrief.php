...
<div class="clearfix position-relative pt-2 pb-4">
	<div class="container">
		...
		<div class="highlight">
			<div class="search-link-articles-filters">
				<div class="row form-row">
                    ...
                    <label class="control-label" for="from_date">From Date </label>
                        ...
                        $data_from_date = array(
                                ...
                                'class' => 'form-control link_article_from_date',
                                'id' => 'from_date',
                    ...
                    <?php 
                        $data_to_date = array(
                                ...
                                'placeholder' => 'To Date',
                                'class' => 'form-control livelinks_to_date',
                                'id' => 'to_date',
                                'data-date-format'=>"yyyy-mm-dd",
                                'data-column' => "2"
                            );
		...
		<div class="table-responsive">
			<table id="link_articles_report" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						<th class="" >Writer</th>
						<th class="text-center"># of Articles Waiting</th>
