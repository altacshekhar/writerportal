									...
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="article-modal-article-type">
												<div class="custom-control custom-radio custom-control-inline">
														<input type="radio" id="blogArticle1" name="articleBlogType" value="article" data-json-category='<?php echo $article_categories ?>' class="custom-control-input" checked>
									...
									<div class="row article-setting">
										...
										<div class="row article-setting">
											<div class="<?php echo ($article['article_id']) ? 'form-group col-md-6 mb-2' : 'form-group col-md-12 mb-2'?>">
												...
												<?php
													echo form_dropdown("article[$lang][article_type]", $types, 'article', 'class="form-control select-2" required="required" data-msg-required="Please select article type" id => "article_type"' );
