...
class Contentarticlesbrief extends Admin_Controller
{
    ...
    public function add($keyword_id, $id = NULL)
    {
        ...
        if ($id) {
			...
			$this->data['articlesbrief']['brief_primary_keyword'] = $this->get_keyword($keyword_id);
			$this->data['articlebrief_paragraph'] = array();
			$this->data['articlebrief_cta'] = array();
		}
	...
	public function getCtaLookUpData()
	{
		...
		if($brief_cta_id)
			$cta_data = $this->contentarticlebrief_cta_model->get($brief_cta_id);
		if(!$cta_data)
		{
		...
		{
			$cta_data = ['cta_website' => $cta_data->brief_cta_website,
				'cta_language_id' => $cta_data->brief_cta_language_id,
				'cta_headline' => $cta_data->brief_cta_headline,
				'cta_sub_headline' => $cta_data->brief_cta_sub_headline,
				'cta_type' => $cta_data->brief_cta_type,
				'cta_button_text' => $cta_data->brief_cta_button_text,
				'cta_button_color' => $cta_data->brief_cta_button_color,
				'cta_background_type' => $cta_data->brief_cta_background_type,
				'cta_background' => $cta_data->brief_cta_background,
				'cta_background_image' => $cta_data->brief_cta_background_image,
				'cta_background_color' => $cta_data->brief_cta_background_color,
				'cta_background_video' => $cta_data->brief_cta_background_video,
				'cta_form_id' => $cta_data->brief_cta_form_id];
			$cta_data = (Object) $cta_data;
		}
