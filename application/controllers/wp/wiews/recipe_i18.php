								...
								<div class="row">
									<div class="col-md-12">
										<div class="page-inner-header mb-2">
											<h3 class="mb-0">Recipe Summary</h3>
										</div>
										...
										<div class="form-group mb-2">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group mb-2">
														<label class="h6">Prep Time</label>
														<?php
															$data_prep_time = array(
																'name' => "article[$lang][prep_time]",
																'value' => set_value("article[$lang][prep_time]", $article['prep_time']),
																'placeholder' => '(ex: 30 Minutes)',
																'class' => 'form-control',
																'required' => 'required',
																'data-msg-required'=>"Please enter prep time"

															);
															echo form_input($data_prep_time);
															echo form_error("article[$lang][prep_time]");
														?>
									</div>
								</div>
												<div class="col-md-4">
													<div class="form-group mb-2">
														<label class="h6">Serving</label>
														<?php
														$data_servings = array(
															'name' => "article[$lang][servings]",
															'value' => set_value("article[$lang][servings]", $article['servings']),
															'placeholder' => 'ex: 5 Servings',
															'class' => 'form-control',
															'required' => 'required',
															'data-msg-required'=>"Please enter serving seo-content-keywords"
														);
														echo form_input($data_servings);
														echo form_error("article[$lang][servings]");
														?>
													</div>
												</div>
											</div>
										...
										<div id="paragraph-<?php echo $section_id?>" class="mb-2 repeat-paragraph p-container" data-repeater-item>
											...
											<div class="collapse <?php if($paragraph['section_image'] ||  $paragraph['section_video'] ) echo 'show';?> image-video-collapse-<?php echo $section_count?> image-video-collapse">
													...
													<div class="inner-repeater">
														<div class="sortable" data-repeater-list="ingredients">
														<?php foreach($paragraph['ingredients'] as $ingredient){
															//pre($ingredient);
															?>
															<div class="mb-1" data-repeater-item>
																<?php
																$data_ingr_id_hide = array(
																	'type' => 'hidden',
																	'name' => 'ingredient_i18_id',
																	'value' => set_value('ingredient_i18_id', $ingredient['ingredient_i18_id']),
																	'class' => 'ingredient_i18_id'
																);
																echo form_input($data_ingr_id_hide);
																$data_ingredient_order_hide = array(
																	'type' => 'hidden',
																	'name' => 'ingredient_order',
																	'value' => set_value('ingredient_order', $ingredient['ingredient_order']),
																	'class' => 'ingredient_order'
																);
																echo form_input($data_ingredient_order_hide);
																?>
																<div class="input-group">
																	...
																	<?php
																	$data_ingredient_name = array(
																		'name' => 'ingredient_name',
																		'value' => set_value('ingredient_name', $ingredient['ingredient_name'], $html_escape=FALSE),
																		'placeholder' => 'Ingredient Name (ex: salted Butter)',
																		'class' => 'form-control seo-content-keywords',
																		'required' => 'required',
																		'data-msg-required'=>"Please enter ingredient"
																	);
																	echo form_input($data_ingredient_name);
																	?>
																	<?php
																	$data_ingredient_qty = array(
																		'name' => 'ingredient_qty',
																		'value' => set_value('ingredient_qty', $ingredient['ingredient_qty'], $html_escape=FALSE),
																		'placeholder' => 'Quantity (ex: 1/2 cup)',
																		'class' => 'form-control seo-content-keywords',
																		'required' => 'required',
																		'data-msg-required'=>"Please enter ingredient qty"
																	);
																	echo form_input($data_ingredient_qty);
																	?>
																	<div data-repeater-delete class="input-group-append data-repeater-delete">
														...
														<div class="form-group overflow-hidden">
															<a class="add-more-link-muted small add-ingredient initial-ingredient-hide" href="javascript:void();" data-repeater-create="">
													...
													<!-- innner repeater -->
													<div class="inner-repeater">
														<div class="sortable" data-repeater-list="steps">
															<?php foreach($paragraph['steps'] as $step){
															//pre($step);
															?>
															<div class="mb-1" data-repeater-item>

																<?php
																$data_step_id_hide = array(
																	'type' => 'hidden',
																	'name' => 'step_i18_id',
																	'value' => set_value('step_i18_id', $step['step_i18_id']),
																	'class' => 'step_i18_id'
																);
																echo form_input($data_step_id_hide);
																$data_step_order_hide = array(
																	'type' => 'hidden',
																	'name' => 'step_order',
																	'value' => set_value('step_order', $step['step_order']),
																	'class' => 'step_order'
																);
																echo form_input($data_step_order_hide);
																?>
																<div class="input-group">
																	<div class="input-group-prepend drag-handle">
																		<span class="input-group-text">
																	...
																	<?php
																	$data_step_description = array(
																		'name' => 'step_description',
																		'value' => set_value('step_description', $step['step_description'], $html_escape=FALSE),
																		'placeholder' => 'ex: Melt the butter in sauce pan at low heat',
																		'class' => 'form-control autoExpand seo-content-keywords',
																		'rows'=> 1,
																		'required' => 'required',
																		'data-msg-required'=>"Please enter Recipe Step"
																	);
																	echo form_textarea($data_step_description);
																	?>
																	<div data-repeater-delete class="input-group-append data-repeater-delete">
																		<span class="input-group-text text-danger">
																	<i class="fas fa-times"></i>
														...
														<div class="form-group overflow-hidden">
														<a class="add-more-link-muted small add-steps initial-steps-hide" href="javascript:void();" data-repeater-create="">
																<i class="fas fa-plus"></i>
																Add Another Recipe Steps
															</a>
														</div>
													</div>
												</div>
								...
								<div class="card">
									...
									<div class="card-body">
										...
										<div class="row">
											...
											<div class="col-md-6 col-sm-6 article-modal-article-type">
												<div class="custom-control custom-radio custom-control-inline">
													<input type="radio" id="topicCluster1" name="siteStructure" value="cluster" class="custom-control-input" data-show-class=".cluster-show" disabled >
													<label class="custom-control-label" for="topicCluster1">Topic Cluster</label>
												</div>
												<div class="custom-control custom-radio custom-control-inline">
													<input type="radio" id="blog1" name="siteStructure" value="blog" class="custom-control-input" data-show-class=".blog-show" checked>
										...
										<div class="row">
											...
											<div class="article-modal-article-type">
												<div class="custom-control custom-radio custom-control-inline">
														<input type="radio" id="blogArticle1" name="articleBlogType" value="article" data-json-category='<?php echo $article_categories ?>' class="custom-control-input" disabled>
														<label class="custom-control-label" for="blogArticle1">Blog Article</label>
													</div>
													<div class="custom-control custom-radio custom-control-inline">
														<input type="radio" id="recipeArticle1" name="articleBlogType" value="recipe" data-json-category='<?php echo $recipe_categories ?>' class="custom-control-input" checked>
														<label class="custom-control-label" for="recipeArticle1">Recipe Article</label>
													</div>
													<div class="custom-control custom-radio custom-control-inline">
														<input type="radio" id="pressRelease1" name="articleBlogType" value="news" data-json-category='<?php echo $news_categories ?>' class="custom-control-input" disabled>
														<label class="custom-control-label" for="pressRelease1">Press Release</label>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="row article-setting">
										...
										<div class="row article-setting">
											<div class="<?php echo ($article['article_id']) ? 'form-group col-md-6 mb-2' : 'form-group col-md-12 mb-2'?>">
												...
												<?php
													echo form_dropdown("article[$lang][article_type]", $types, 'recipe', 'class="form-control select-2" required="required" data-msg-required="Please select article type"  id => "article_type"' );
