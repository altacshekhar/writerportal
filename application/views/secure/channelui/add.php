			...
			<div id="profile-tab" class="content-panel py-2 px-3">
				<div class="clearfix">
					<h3 class="h4">
						...
						Promotional Message UI Channel Configuration
					</h3>
					<hr class=" mb-2">
				</div>
				<?php echo form_open_multipart('', array('class' => 'form-horizontal form-validate', 'id' => 'channeluiconfig-form'));?>
					...
					<div class="form-group row">
						...
						<div class="col-sm-6">
							...
							echo form_dropdown('article_promo_channel_status', $channel_status, $channel_config_row["article_promo_channel_status"], 'class="custom-select"' );
							echo form_error('article_promo_channel_status');
							?>
							<small class="form-text text-muted">
								Set the status of promotion channel
							</small>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-6">
							...
							echo form_dropdown('article_promo_channel_show_headline', $headline, $channel_config_row["article_promo_channel_show_headline"], 'class="custom-select"' );
							echo form_error('article_promo_channel_show_headline');
							?>
							<small class="form-text text-muted">
								Set the headline show or hide for promotion channel
							</small>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-6">
							...
							echo form_dropdown('article_promo_channel_show_msg_intro', $msg_intro, $channel_config_row["article_promo_channel_show_msg_intro"], 'class="custom-select"' );
							echo form_error('article_promo_channel_show_msg_intro');
							?>
							<small class="form-text text-muted">
								Set the message intro show or hide for promotion channel
							</small>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-6">
							...
							echo form_dropdown('article_promo_channel_show_msg_text', $msg_text, $channel_config_row["article_promo_channel_show_msg_text"], 'class="custom-select"' );
							echo form_error('article_promo_channel_show_msg_text');
							?>
							<small class="form-text text-muted">
								Set the message text show or hide for promotion channel
							</small>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-6">
							...
							echo form_dropdown('article_promo_channel_show_msg_url_link', $msg_url_link, $channel_config_row["article_promo_channel_show_msg_url_link"], 'class="custom-select"' );
							echo form_error('article_promo_channel_show_msg_url_link');
							?>
							<small class="form-text text-muted">
								Set the message url link show or hide for promotion channel
							</small>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<?php
							$msg_multimedia = array(
								true  	=> 'True',
								false 	=> 'False'
							);
							echo form_dropdown('article_promo_channel_show_msg_multimedia', $msg_multimedia, $channel_config_row["article_promo_channel_show_msg_multimedia"], 'class="custom-select"' );
							echo form_error('article_promo_channel_show_msg_multimedia');
							?>
							<small class="form-text text-muted">
								Set the message multi-media show or hide for promotion channel
							</small>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-6">
							...
							echo form_dropdown('article_promo_channel_show_msg_cta', $msg_cta, $channel_config_row["article_promo_channel_show_msg_cta"], 'class="custom-select"' );
							echo form_error('article_promo_channel_show_msg_cta');
							?>
							<small class="form-text text-muted">
								Set the message cta show or hide for promotion channel
							</small>
						</div>
					</div>
