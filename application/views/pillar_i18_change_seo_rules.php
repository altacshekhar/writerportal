								...
								<div class="col-md-12">
									...
									<div class="form-group mb-2">
										...
										<div class="row">
											...
											<div class="col-md-1">
												<span class="text-danger font-weight-bold"><i data-toggle="tooltip" data-html="true" data-placement="top" title="<small>The primary keyword phrase does not appear in the title.</small>" class="fas fa-exclamation-triangle"></i></span>
												<span class="text-warning font-weight-bold"><i data-toggle="tooltip" data-html="true" data-placement="top" title="<small>The primary keyword phrase does not appear in the title.</small>" class="fas fa-exclamation-triangle"></i></span>
											</div>
										</div>
											...
											<div class="col-md-11">
												<div class="position-relative">
													<div class="holder-style holder-active embed-responsive remove-youtube-tab mb-2 <?php if($article_image) echo 'embed-responsive-16by9';?>"
														href="#pixabayModal" data-toggle="modal" data-target="#pixabayModal"
													...
													<a href="javascript:void(0);"
														...
														data-action="article|<?php echo $lang ?>|<?php echo $article['article_id']?>|<?php echo $article['article_image']?>|0"
									...
									<div class="form-group mb-2 section-image-found">
										...
										<div class="row">
											...
											<div class="col-md-1">
												<span class="text-danger font-weight-bold"><i data-toggle="tooltip" data-html="true" data-placement="top" title="<small>A keyword does not appear in the image description.</small>" class="fas fa-exclamation-triangle"></i></span>
											</div>
										</div>
									</div>
									<div class="form-group mb-2">
										...
										<div class="row">
											...
											<div class="col-md-1">
												<span class="text-danger font-weight-bold"><i data-toggle="tooltip" data-html="true" data-placement="top" title="<small>The primary keyword phrase does not appear in the article summary.</small>" class="fas fa-exclamation-triangle"></i></span>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="col-md-12">
											...
											<div class="form-group mb-2">
												...
												<div class="row">
													...
													<div class="col-md-1">
														<span class="text-danger font-weight-bold"><i data-toggle="tooltip" data-html="true" data-placement="top" title="<small>A keyword does not appear in the paragraph title.</small>" class="fas fa-exclamation-triangle"></i></span>
													</div>
												</div>
														...
														<div class="col-md-11">
															<div class="position-relative">
																...
																<a href="javascript:void(0);"
																	...
																	data-action="section|<?php echo $lang ?>|<?php echo $paragraph['section_id']?>|<?php echo $paragraph['section_image']?>|0"
																	data-toggle="tooltip" data-placement="top"
											...
											<div class="form-group">
												...
												<div class="row">
													...
													<div class="col-md-1">
															...
															<span class="text-danger font-weight-bold"><i data-toggle="tooltip" data-html="true" data-placement="top" title="<small>The primary keyword phrase does not appear in the first paragraph of the article.</small>" class="fas fa-exclamation-triangle"></i></span>
															<?php } ?>
															<span class="text-danger font-weight-bold"><i data-toggle="tooltip" data-html="true" data-placement="top" title="" class="fas fa-exclamation-triangle para_sentences" ></i></span>
													</div>
												</div>
											</div>
											<!---- Callout Start ---->
				...
				<div class="repeater-social-media-section">
					...
					<div data-repeater-list="<?php echo $channel->article_promo_channel ?>">
						<?php
							...
							?>
						<div id="socialmedia-<?php echo $msg_id ?>"
							class="social-media-repeater-item p-container" data-repeater-item>
							...
							<div class="row">
								...
								<div class="col-md-7">
									...
									<div class="form-group mb-2">
										<div class="row">
											<div class="col-md-8">
												<label class="h6">Introduction Text<span
														class="text-danger"></span>
												</label>
											</div>
											<div class="col-md-4 text-right">
									...
									<div class="form-group mb-2">
										<div class="row">
											<div class="col-md-8">
												<label class="h6">Description Text<span
														class="text-danger"></span>
												</label>
											</div>
											<div class="col-md-4 text-right">
									...
									<div class="mb-2">
										<div class="row">
											...
											<div
												class="<?php echo ($channel->article_promo_channel_show_msg_url_link) ? 'col-md-6' : 'col-md-12'?>">
												<div class="form-group">
													<label class="h6">Call To Action<span
															class="text-danger"></span>
											...
											<div
												class="<?php echo ($channel->article_promo_channel_show_msg_cta) ? 'col-md-6' : 'col-md-12'?>">
												<div class="form-group">
													<label class="h6">
						...
						<div class="col-md-12">
							<div class="card">
								...
								<div class="card-body">
									...
									<div class="row">
										...
										<div class="col-sm-6 article-modal-type">
											<div class="article-modal-article-type cluster-show">
												<div class="custom-control custom-radio custom-control-inline">
													<input type="radio" id="pillarArticle1" name="articleClusterType" value="pillar" class="custom-control-input"  data-show-class=".pillar-show" checked>
													<label class="custom-control-label" for="pillarArticle1">Pillar Article</label>
												</div>
												<div class="custom-control custom-radio custom-control-inline">
													<input type="radio" id="supportingArticle1" name="articleClusterType" value="supporting" class="custom-control-input"  data-show-class=".supporting-show" disabled>
									...
									<div class="row">
										...
										<div class="form-group col-md-6 col-sm-6">
											<?php
														...
														$data_article_icon = array(
															'name' => "article[$lang][article_icon]",
															'value' => set_value("article[$lang][article_icon]", $article['article_icon'], $html_escape=FALSE),
															'placeholder' => 'Please enter icon ex (fas fa-pen)',
															'class' => 'form-control article-iconpicker',
															'required' => 'required',
															'autocomplete' => 'off',
															'data-msg-required'=>"Please enter icon"
														);
														echo form_input($data_article_icon);
														echo form_error("article[$lang][article_icon]");
													?>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										...
										<div class="form-group col-md-6 col-sm-6">
											<?php
													...
													?>
											<label class="m-0" data-on-label="YES" data-off-label="NO"
												for="article_skyscraper_chk"></label>
										</div>
									</div>
									<div class="form-group row hide">
										<label
											class="col-md-6 col-sm-6 h6 d-block col-form-label"
											for="article_toc_ordered">
											Grammar and Spelling
										</label>
										<div class="col-md-6 col-sm-6">
											<button type="button" value="check_spelling"
												class="btn btn-sm w-50 btn-success check_spelling_1">
												Verify
											</button>
										</div>
									</div>
									<div class="form-group row hide">
										...
										<div class="col-md-6 col-sm-6">
											<button type="button"
												...
												data-lang="<?php echo $article['language_id'] ?>"
												value="copyscape"
												class="btn btn-sm w-50 btn-success verify_copyscape">
												Verify
											</button>
											<span
												id="verify_copyscape"><?php if($article['article_copyscape']){ ?><i
													class="fas fa-check-square" aria-hidden="true"
													style="color:#5ed84f"></i><?php } ?></span>
										</div>
									</div>
									<div class="form-group row">
										<label class="col-md-6 col-sm-6 h6  d-block col-form-label"
											for="article_toc_ordered">
									...
									<div class="row article-setting">
										<div
											class="<?php echo ($article['article_id']) ? 'form-group col-md-6 mb-2' : 'form-group col-md-12 mb-2'?>">
											<label class="h6">Type</label>
											<?php
													echo form_dropdown("article[$lang][article_type]", $types, 'pillar', 'class="form-control select-2" required="required" data-msg-required="Please select article type" id => "article_type"' );
