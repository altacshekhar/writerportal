...
<div class="clearfix position-relative py-5">
	...
	<div class="view-account">
			...
			<div id="profile-tab" class="content-panel py-2 px-3">
				...
				<?php echo form_open_multipart('', array('class' => 'form-horizontal form-validate', 'id' => 'emailconfig-form'));?>
					<div class="form-group row">
						<label class="col-md-4 col-sm-6 h6 col-form-label" for="emailconfig_from_name">
							Name to send mail as
						</label>
						<div class="col-sm-6">
							<?php
							$data_site_id = array(
								'id' => 'emailconfig_from_name',
								'name' => 'emailconfig_from_name',
								'value' => set_value('emailconfig_from_name', $config_row['emailconfig_from_name']),
								'placeholder' => 'Set the from name for email sent by Writer Portal',
								'class' => 'form-control'
							);
							echo form_input($data_site_id);
							?>
							<small class="form-text text-muted">
								Set the from name for email sent by Writer Portal
							</small>
							<?php echo form_error('emailconfig_from_name');?>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-md-4 col-sm-6 h6 col-form-label" for="emailconfig_from_email">
							E-mail address to send mail from
						</label>
						<div class="col-sm-6">
							<?php
							$data_site_id = array(
								'id' => 'emailconfig_from_email',
								'name' => 'emailconfig_from_email',
								'value' => set_value('emailconfig_from_email', $config_row['emailconfig_from_email']),
								'placeholder' => 'Set the from name for email sent by Writer Portal',
								'class' => 'form-control'
							);
							echo form_input($data_site_id);
							?>
							<small class="form-text text-muted">
								Set the from email for email sent by Writer Portal
							</small>
							<?php echo form_error('emailconfig_from_email');?>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-md-4 col-sm-6 h6 col-form-label" for="emailconfig_smtp_host">
							host
						</label>
						<div class="col-sm-6">
							<?php
							$data_site_id = array(
								'id' => 'emailconfig_smtp_host',
								'name' => 'emailconfig_smtp_host',
								'value' => set_value('emailconfig_smtp_host', $config_row['emailconfig_smtp_host']),
								'placeholder' => '',
								'class' => 'form-control'
							);
							echo form_input($data_site_id);
							?>
							<small class="form-text text-muted">
								Set url for the mail service host.
							</small>
							<?php echo form_error('emailconfig_smtp_host');?>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-md-4 col-sm-6 h6 col-form-label" for="emailconfig_smtp_port">
							Port
						</label>
						<div class="col-sm-6">
							<?php
							$data_site_id = array(
								'id' => 'emailconfig_smtp_port',
								'name' => 'emailconfig_smtp_port',
								'value' => set_value('emailconfig_smtp_port', $config_row['emailconfig_smtp_port']),
								'placeholder' => '',
								'class' => 'form-control'
							);
							echo form_input($data_site_id);
							?>
							<small class="form-text text-muted">
								Port to use to connect to the mail host
							</small>
							<?php echo form_error('emailconfig_smtp_port');?>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-6">
							<?php
							$encryption_type = array(
								''		=> 'None',
								'ssl'  	=> 'SSL',
								'tls' 	=> 'TLS',
							);
							echo form_dropdown('emailconfig_smtp_crypto', $encryption_type, $config_row["emailconfig_smtp_crypto"], 'class="custom-select"' );
							echo form_error('emailconfig_smtp_crypto');
							?>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-md-4 col-sm-6 h6 col-form-label" for="emailconfig_smtp_user">
							Username for the Mail service
						</label>
						<div class="col-sm-6">
							<?php
							$data_site_id = array(
								'id' => 'emailconfig_smtp_user',
								'name' => 'emailconfig_smtp_user',
								'value' => set_value('emailconfig_smtp_user', $config_row['emailconfig_smtp_user']),
								'placeholder' => '',
								'class' => 'form-control'
							);
							echo form_input($data_site_id);
							?>
							<small class="form-text text-muted">
								Set the username required to authenticate the  mail service
							</small>
							<?php echo form_error('emailconfig_smtp_user');?>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-md-4 col-sm-6 h6 col-form-label" for="emailconfig_smtp_pass">
							Password for the  mail service
						</label>
						<div class="col-sm-6">
							<?php
							$data_site_id = array(
								'id' => 'emailconfig_smtp_pass',
							//	'type' => 'password',
								'name' => 'emailconfig_smtp_pass',
								'value' => set_value('emailconfig_smtp_pass', $config_row['emailconfig_smtp_pass']),
							...
							?>
							<small class="form-text text-muted">
								Set the password required to authenticate the mail service
							</small>
							<?php echo form_error('emailconfig_smtp_pass');?>
						</div>
					</div>
