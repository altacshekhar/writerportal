	...
	<div class="container">
		<div class="d-flex justify-content-between">
			...
			<div class="toolbar-action">
				<div class="btn-group">
					<a class="btn btn-white" href="<?php echo site_url('/secure/channels/add'); ?>" role="button">
		...
		<div class="table-responsive">
			<table id="channel_list_table" class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						<th class="text-center" style="width: 1rem;">#Id</th>
						<th class="text-center" style="width: 9rem;">Channel</th>
						<th class="text-center" style="width: 9rem;">Apikey</th>
						...
						<!--<th class="text-center" style="width: 9rem;" >Days</th>
						<th class="text-center" style="width: 9rem;" >Times</th>-->
