...
<section id="container">
  <div class="container notfoundpanel">
    ...
    <h4 class="animated fadeInDown">The page you are looking for might have been removed, had its name changed, or unavailable.</h4>
	<a class="btn btn-primary animated fadeInDown" href="<?php echo site_url() ?>">
		GO TO HOME PAGE
	</a>
