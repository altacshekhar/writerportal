...
class Pressrelease extends Frontend_Controller
{
    ...
    public function index($id = null, $lang = 'en')
    {
      ...
      //pre_exit($social_channels);
       ...
       /* $this->data['twitters'] = $twitters;
        ...
        $this->data['category'] = $this->category_model->get_category_by_array('news');
            ...
            /*** Paragraphs End ****/
				...
				$msg_info = $this->promotion_model->get_promo_message_id($article_last_insert_id, $lang, $channel_name);
                                ...
                                if($article['article_site_id'] == 'rmagazine.com'){
                                    ...
                                    $social_data_save['msg_url_link'] = 'https://' . $article['article_site_id'] . '/news/' . slugify($this->input->post("article[$lang][article_title]")) . '.html';
                                }
		...
		$this->data['subview'] = 'pressrelease';
		$this->data['nestedview'] = 'pressrelease_i18';
		$this->data['meta_title'] = 'Press Release';
